module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('reports', 'value', { transaction });

      await queryInterface.removeColumn('reports', 'kpi', { transaction });

      await queryInterface.removeColumn('reports', 'report_name', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('leads', 'contact_information', {
        transaction,
      });

      await queryInterface.removeColumn('leads', 'customer_name', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('invoices', 'leadId', { transaction });

      await queryInterface.removeColumn('interactions', 'notes', {
        transaction,
      });

      await queryInterface.removeColumn('interactions', 'interaction_time', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('appointments', 'confirmation_status', {
        transaction,
      });
